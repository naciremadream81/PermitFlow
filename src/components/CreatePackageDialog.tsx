...
export function CreatePackageDialog({ open, onOpenChange, onPackageCreate }: CreatePackageDialogProps) {
  ...
  const onSubmit = (data: PackageFormValues) => {
    ...
    // The ID will be auto-generated by Firestore, so we can omit it here.
    const newPackageData: Omit<PermitPackage, 'id'> = {
    ...
    const userPackagesRef = collection(firestore, 'users', user.uid, 'permitPackages');
    addDocumentNonBlocking(userPackagesRef, newPackageData);

    toast({
        title: "Package Created",
        description: `${data.packageName} has been created and saved.`
    })
